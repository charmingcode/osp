...
class AsyncLogger : public google::base::Logger {
 ...
 private:
  ...
  struct Buffer {
    ...
    bool needs_flush_or_write() const { return flush || !messages.empty(); }
